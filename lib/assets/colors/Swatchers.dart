...
List<String> darkAccentColorsNames = [
  "black",
  "White",
  "kilamanjaro",
  "firefly",
...
List<Color> accentColors = [
  ...
  Colors.black,
  Colors.deepPurple[100], //deepPurple
  Colors.indigo[100], //indigo
  Colors.blue[100], //blue
  Colors.lightBlue[100], //lightBlue
  Colors.cyan[100], //cyan
  Colors.teal[100], //teal
  Colors.green[100], //green
  Colors.lightGreen[100], //lightGreen
  Colors.lime[100], //lime
  Colors.yellow[100], //yellow
  Colors.amber[100], //amber
  Colors.orange[100], //orange
  Colors.deepOrange[100], //deepOrange
  Colors.brown[100], //bro
  Colors.blueGrey[100], //bl
];
